...
;banner5:
 ;       .asciiz "|   ####  ####  #      ###  |"
msghello1: 
        .asciiz "Based on OS/1(Alpha+C) of DB6502"
msghello2: 
        .asciiz "Welcome to AT OS/1 shell for AT6502 computer"
msghello3:
...
msgsmon:
        .asciiz "Running SMON 6502 application..."
msgassembler:
        .asciiz "Running Assembler..."
msginfo:
...
menu:
        ...
        menuitem blink_cmd2,  2, blink_desc2,   _process_blink2
        menuitem info_cmd,    1, info_desc,    _process_info
        menuitem smon_cmd,    1, smon_desc,    _process_smon
        endmenu 
...
blink_cmd2:
        .asciiz "BLINK2"        
blink_desc:
        .asciiz "BLINK1 on/off - toggle onboard blink LED"
blink_desc2:
        .asciiz "BLINK2 on/off - toggle an added LED on VIA 2"        
info_cmd:
        .asciiz "INFO"
info_desc:
...
smon_cmd:
        .asciiz "SMON"
smon_desc:
        .asciiz "SMON - run SMON 6502 by David Hansel (2023)"        