...
I have created a separate page [here](https://github.com/Kayto/AT65C02/blob/main/Jumpers.md) to explain them.
...
|-----------|-------------|--------|
| **[50_mem_read](https://github.com/Kayto/AT65C02/tree/main/Software/50_mem_read)** | RAM test, VIA1 and VIA 2 test blinks | by me - needs to be combined with the DB6502 repo for compilation. |
